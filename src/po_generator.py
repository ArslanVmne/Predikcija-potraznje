...
def generate_po_excel(
    ...
    # ── Column widths ──────────────────────────────────────────────────────────
    col_widths = [22, 10, 6, 18, 14, 14, 14, 12]
    ...
    ws.cell(row=summary_row, column=5, value="TOTAL ORDER VALUE:").font = Font(bold=True, size=11, color="1E3A5F")
    total_cell = ws.cell(row=summary_row, column=7, value=total_value)
    total_cell.font = Font(bold=True, size=11, color="1E3A5F")
    total_cell.number_format = '$#,##0.00'

    ws.cell(row=summary_row + 1, column=5, value="Urgent (A-class) items:").font = Font(size=10, color="DC2626")
    ws.cell(row=summary_row + 1, column=7, value=urgent_count).font = Font(bold=True, size=10, color="DC2626")
