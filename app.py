...
k1.metric("Stores monitored", kpis["stores"],
          help="Number of grocery store locations in the system.")
k2.metric("Product families", kpis["families"],
          help="Number of product categories tracked across all stores.")
k3.metric("15-day forecast total", f"{kpis['forecast_total']:,} units",
          help="Total projected demand for Aug 1-15, 2017 across all stores and product families, generated by the ensemble model.")
k4.metric("A-class SKUs below safety stock", kpis["critical_skus"],
          ...
          help="High-value products (top 80% of revenue) currently below their minimum safety buffer. Go to Orders to generate a purchase order.")
